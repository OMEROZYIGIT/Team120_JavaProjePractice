...
public class Registration {
    ...
    /*
     2- Registration(Kayıt) isminde bir class oluşturun
     ve
     register()(kayıtAl()) isminde bir metod ekleyerek
    ...
    static ArrayList<User> register() {
        ...
        User kullanici = new User(name, time);    // paremetreli cons. kullanarak user class ından obje oluşturduk
