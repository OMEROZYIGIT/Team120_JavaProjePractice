...
public class Atm {
    ...
    public static void main(String[] args) {
        ...
        giris();  // giris diye method oluşturalım
    ...
    public static void giris() {
        ...
        // eğer kKarNo eşitse kartNo ve kSifre eşitse sifre
        if (kKartNo.equals(kartNo) && kSifre.equals(sifre)) {
            // menu methoduna git
            menu();

            // girilenler doğru değilse aşağıdakini yazdır ve giris sayfası methoduna tekrar dön
        } else {
    ...
    public static void menu() {
        ...
        switch (secim) {
            ...
            case 2: {
                ...
                // paraYatirma(miktar) methoduna git
                paraYatirma(miktar);
            }
            case 3: {
                ...
                // double miktar = scan.nextDouble();
                // paraCekme methouna git ve scandaki datayı al
                paraCekme(scan.nextDouble());
            }
            case 4: {
                // paraGonderme() methoduna git
                paraGonderme();
            }
            case 5: {
                // sifreDegistirme() methoduna git
                sifreDegistirme();
            }
            case 6: {
                // eğer 6 ya basılırsa aşağıdakini yazıdırır
                System.out.println("BIZI SECTIGINIZ ICIN TESEKKURLER...");
                System.exit(0);
            }
            default: {
                // 1 den 6 ya kadar rakamlardan başkasına basılırsa aşağıdakini yazdırır ve menu metoduna geri döndürür
